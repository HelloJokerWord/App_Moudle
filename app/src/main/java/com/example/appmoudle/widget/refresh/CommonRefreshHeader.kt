package com.example.appmoudle.widget.refresh
...
class CommonRefreshHeader : FrameLayout, RefreshHeader {
    ...
    private fun initView(context: Context) {
        ...
        view?.setBackgroundResource(R.drawable.hc_shape_transparent)
        this.setBackgroundResource(R.drawable.hc_shape_transparent)
