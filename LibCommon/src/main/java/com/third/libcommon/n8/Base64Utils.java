 ...
 * <ul>
 *     解码
 *     <li>{@link #decode(String)} Converts a Base64 encoded string to a byte array.</li>
 *     <li>{@link #decode(String, int, int)} Converts an embedded Base64 encoded string to a byte array.</li>
 * </ul>
 * <ul>
 *     加密
 *     <li>{@link #encode(byte[])} Converts a byte array into a Base64 encoded string.</li>
 *     <li>{@link #encode(byte[], int, int)} Converts a byte array into a Base64 encoded string.</li>
 *     <li>{@link #encode(String)} Converts a base64 string into a Base64 encoded string.</li>
 * </ul>
 */
public class Base64Utils {
    ...
    public static String getDecodeString(String encoded) {
        try {
     ...
     * @throws java.io.IOException is thrown, if an I/O error occurs reading the data
     */
