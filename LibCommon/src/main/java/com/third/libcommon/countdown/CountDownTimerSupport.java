...
/**
 * 创建人: Joker
 * 创建日期: 2020/5/30. 11:33
 * 说明: 倒计时工具  相比原生解决兼容性问题
 */
public class CountDownTimerSupport implements ITimerSupport {
    ...
    private void cancelTimer() {
        try {
            ...
            e.printStackTrace();
            //java.lang.NullPointerException: Attempt to invoke virtual method 'int java.util.Timer.purge()' on a null object reference
        }
    }
